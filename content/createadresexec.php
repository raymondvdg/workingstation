...
$required = array('adresNaam', 'adresStraat', 'adresPostcode', 'adresStad', 'adresLand');
...
$adresNaam = ucwords(strtolower($adresNaam));
...
$db = new database();
$conn = $db->connect();
$SQL= $conn->prepare("INSERT into adresTabel (adresNaam, adresStraat, adresPostcode, adresStad, adresLand, adresTelefoon, adresBtw, adresEORI, adresRekening, adresContact, adresEmail, adresType, adresPost, adresIban) VALUES (:adresNaam, :adresStraat, :adresPostcode, :adresStad, :adresLand, :adresTelefoon, :adresBtw, :adresEORI, :adresRekening, :adresContact, :adresEmail, :adresType, :adresPost, :adresIban)");
...
print "Adres is aangemaakt.<Br /><a href='begin.php?id=getadres&klantnaam=$urlnaam'>Bekijk file.</a>";
}
